...
public class UserHttpTest {
    ...
    public void setUp() {
        ...
        String uniqueEmail = "test" + UUID.randomUUID().toString().substring(0, 8) + "@mail.ru";
        user = new User(uniqueEmail, "123456", "Daria");
    }
    ...
    @Description("Проверяем, что код ответа 200 и токен не null")
    ...
    public void changeAuthUser() {
        ...
        user.setEmail("changed" + UUID.randomUUID().toString().substring(0, 8) + "@mail.ru");
